...
1. Refatoração em 3 microsserviços independentes
    ...
    2. Veja [ADR 0001 - Divisão em Microsserviços](../9.%20ADRs/0001_adr_divisao_em_microsservicos.md)
2. Bancos de dados isolados e ao menos um banco relacional e um não relacional
    1. Veja [ADR 0004 - Banco de Dados por Serviço](../9.%20ADRs/0004_adr_banco_de_dados_por_servico.md)
    2. [Banco de dados - Cadastro (PostgreSQL)](../3.%20Banco%20de%20dados/1_banco_de_dados_cadastro.md)
    3. [Banco de dados - Estoque (PostgreSQL)](../3.%20Banco%20de%20dados/2_banco_de_dados_estoque.md)
    4. [Banco de dados - Ordem de Serviço (MongoDB/DocumentDB)](../3.%20Banco%20de%20dados/3_banco_de_dados_ordem_servico.md)
...
3. [Diagrama de Componentes](../2.%20Diagrama%20de%20componentes%20%28C4%29/1_diagrama_de_componentes.md)
4. Comunicação síncrona e assíncrona
    1. [Comunicação síncrona](../7.%20Comunicação%20entre%20serviços/1_comunicacao_sincrona.md)
    2. [Comunicação assíncrona e SAGA](../7.%20Comunicação%20entre%20serviços/2_comunicacao_assincrona_saga.md)
    3. Veja [ADR 0002 - Comunicação entre Serviços via NLB](../9.%20ADRs/0002_adr_comunicacao_entre_servicos_via_nlb.md)
5. SAGA Pattern
    1. [Comunicação assíncrona e SAGA](../7.%20Comunicação%20entre%20serviços/2_comunicacao_assincrona_saga.md)
    2. Veja [ADR 0003 - SAGA Coreografada](../9.%20ADRs/0003_adr_saga_coreografada.md) - justificativa de coreografia ao invés de orquestração
    3. [Custom events e monitoramento da compensação](../6.%20Plano%20de%20monitoramento/1_plano_de_monitoramento.md)
6. Qualidade e Testes
    1. [Qualidade - Cadastro](../8.%20Testes%20e%20qualidade/1_qualidade_cadastro.md)
    2. [Qualidade - Estoque](../8.%20Testes%20e%20qualidade/2_qualidade_estoque.md)
    3. [Qualidade - Ordem de Serviço](../8.%20Testes%20e%20qualidade/3_qualidade_ordem_servico.md)
    4. [Qualidade - Auth Lambda](../8.%20Testes%20e%20qualidade/4_qualidade_auth_lambda.md)
    5. [Qualidade - Infraestrutura](../8.%20Testes%20e%20qualidade/5_qualidade_infra.md)
    6. Veja [ADR 0009 - CI Obrigatória com Test Coverage e SonarCloud](../9.%20ADRs/0009_adr_ci_obrigatoria_test_coverage_e_sonar.md)
    7. Veja [CI/CD](../5.%20CI%20%26%20CD/1_ci_cd.md)
7. [BDD](../8.%20Testes%20e%20qualidade/6_BDD.md)
8. CI/CD automatizado e proteção das branchs
    1. Veja [CI/CD](../5.%20CI%20%26%20CD/1_ci_cd.md)
    2. Veja [ADR 0009 - CI Obrigatória com Test Coverage e SonarCloud](../9.%20ADRs/0009_adr_ci_obrigatoria_test_coverage_e_sonar.md)
    3. Pipelines:
...
10. [Observabilidade e monitoramento](../6.%20Plano%20de%20monitoramento/1_plano_de_monitoramento.md)
11. [RFCs e ADRs](../9.%20ADRs/0001_adr_divisao_em_microsservicos.md)
12. [Autenticação](../4.%20Autenticação/1_autenticacao.md)
...
Próximo: [Diagrama de componentes](../2.%20Diagrama%20de%20componentes%20%28C4%29/1_diagrama_de_componentes.md)
